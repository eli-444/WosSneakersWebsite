...
const OrderTable = ({ setContextFilters }: OrderTableProps) => {
  ...
  useEffect(() => {
    ...
    fetch(
      `/admin/orders?order=-created_at&fields=id,status,display_id,created_at,email,fulfillment_status,payment_status,total,currency_code,metadata,items,*customer,discount_total,discount_tax_total&limit=${
